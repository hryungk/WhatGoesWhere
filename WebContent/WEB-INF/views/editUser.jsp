    ...
    <section> 
        ...
        <div>
           <form action="./editUser" method="post">
                <fieldset>
                    <legend>Please edit the form below:</legend>
                    <h6>(all fields are required)</h6>
                    <h6 style="color: red;" ><c:out value="${usernameMessage }" /></h6>
                    <h6 style="color: red;"><c:out value="${emailMessage }" /></h6>
                    <div class="r-input">                    	
						<input type="text" name="userName" placeholder="Username" required="required" value="${username }" id="username" />
					</div>
					<div class="r-input">						
					...
					<div class="r-input">
						<input type="text" name="date" placeholder="Joined on MM-DD-YYYY" disabled="disabled" 
						value="<c:out value="${user.joinedDate }" />" />
					</div>
                </fieldset>
